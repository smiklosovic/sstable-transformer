...
----
$ java -jar target/sstable-transformer-1.0.0-SNAPSHOT-bundled.jar help
...
----
java -jar target/sstable-transformer-1.0.0-SNAPSHOT-bundled.jar transform \
  --keyspace=spark_test \
  --table=test3 \
...
----
$ java -jar target/sstable-transformer-1.0.0-SNAPSHOT-bundled.jar partitions \
    --dc=dc1 \
    --keyspace=spark_test \
...
----
 $ java -jar target/sstable-transformer-1.0.0-SNAPSHOT-bundled.jar transform help
Usage: transformer transform [--bloom-filter] [--sorted]
...
----
$ java -jar target/sstable-transformer-1.0.0-SNAPSHOT-bundled.jar help partitions
